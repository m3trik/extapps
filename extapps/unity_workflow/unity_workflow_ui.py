...
################################################################################
## Form generated from reading UI file 'unity_workflow.ui'
##
...
class Ui_QtUi(object):
    ...
    def retranslateUi(self, QtUi):
        self.header.setText(QCoreApplication.translate("QtUi", u"UNITY WORKFLOW", None))
        self.grp_process.setTitle("")
#if QT_CONFIG(tooltip)
        self.cmb000.setToolTip(QCoreApplication.translate("QtUi", u"How the model is delivered to the Unity project (copy the file into Assets/).", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.b000.setToolTip(QCoreApplication.translate("QtUi", u"Copy the chosen model file into the Unity project's Assets/ (and optionally launch the Editor).", None))
#endif // QT_CONFIG(tooltip)
        self.b000.setText(QCoreApplication.translate("QtUi", u"Send to Unity", None))
#if QT_CONFIG(tooltip)
