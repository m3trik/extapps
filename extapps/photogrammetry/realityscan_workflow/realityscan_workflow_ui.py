...
################################################################################
## Form generated from reading UI file 'realityscan_workflow.ui'
##
...
class Ui_QtUi(object):
    ...
    def retranslateUi(self, QtUi):
        self.header.setText(QCoreApplication.translate("QtUi", u"REALITYCAPTURE WORKFLOW", None))
        self.grp_process.setTitle("")
#if QT_CONFIG(tooltip)
        self.cmb000.setToolTip(QCoreApplication.translate("QtUi", u"Pipeline run mode.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.b000.setToolTip(QCoreApplication.translate("QtUi", u"Run the RealityCapture pipeline headless in the local install.", None))
#endif // QT_CONFIG(tooltip)
