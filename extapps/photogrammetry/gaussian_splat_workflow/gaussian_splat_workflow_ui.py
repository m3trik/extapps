...
################################################################################
## Form generated from reading UI file 'gaussian_splat_workflow.ui'
##
...
class Ui_QtUi(object):
    ...
    def retranslateUi(self, QtUi):
        self.header.setText(QCoreApplication.translate("QtUi", u"BRUSH SPLAT WORKFLOW", None))
        self.grp_process.setTitle("")
#if QT_CONFIG(tooltip)
        self.cmb000.setToolTip(QCoreApplication.translate("QtUi", u"Run mode (Train only, or Train + Publish to engine formats).", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.b000.setToolTip(QCoreApplication.translate("QtUi", u"Train the gaussian splat (and optionally publish) in the local Brush install.", None))
#endif // QT_CONFIG(tooltip)
